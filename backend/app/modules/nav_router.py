...
DEFAULT_NAV_ORDER = ["dashboard", "calendar", "shopping", "tasks", "meal_plans", "recipes", "contacts", "notifications", "settings", "admin"]
KNOWN_KEYS = {"dashboard", "calendar", "shopping", "tasks", "rewards", "gifts", "meal_plans", "recipes", "contacts", "notifications", "settings", "admin"}
