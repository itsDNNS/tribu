...
SCOPE_DESCRIPTIONS: dict[str, str] = {
    ...
    "shopping:read": "View shopping lists, items, templates, and store search links",
    "shopping:write": "Create, update, and delete shopping lists, items, templates, and store search links",
