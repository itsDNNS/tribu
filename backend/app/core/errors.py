...
SHOPPING_STORE_LINK_NOT_FOUND = "SHOPPING_STORE_LINK_NOT_FOUND"
SHOPPING_STORE_LINK_LIMIT_REACHED = "SHOPPING_STORE_LINK_LIMIT_REACHED"
SHOPPING_STORE_LINK_NAME_TAKEN = "SHOPPING_STORE_LINK_NAME_TAKEN"
SHOPPING_STORE_LINK_INVALID_TEMPLATE = "SHOPPING_STORE_LINK_INVALID_TEMPLATE"
...
_DEFAULT_MESSAGES: dict[str, str] = {
    ...
    SHOPPING_STORE_LINK_NOT_FOUND: "Store link not found",
    SHOPPING_STORE_LINK_LIMIT_REACHED: "Maximum {limit} store links reached",
    SHOPPING_STORE_LINK_NAME_TAKEN: "A store with this name already exists",
    SHOPPING_STORE_LINK_INVALID_TEMPLATE: "Search address must be an http or https URL that contains the item placeholder exactly once",
