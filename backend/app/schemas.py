...
class CalendarEventUpdate(BaseModel):
    ...
    ends_at: Optional[datetime] = Field(None, description="End date/time; null clears it, omission preserves it")
    description: Optional[str] = Field(None, description="Event description")
...
class CalendarEventResponse(BaseModel):
    ...
    description: Optional[str] = Field(None, description="Event description")
    location: Optional[str] = Field(None, description="Free-form place name or address for the event")
